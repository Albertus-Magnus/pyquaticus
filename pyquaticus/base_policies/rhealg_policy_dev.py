...
from pyquaticus.utils.rewards import test_reward_func, aggressive_rew, caps_and_grabs, defensive_rew
...
class RHEA_Environment(Environment):
    ...
    def __init__(self, env):
        ...
        self.env = pyquaticus_v0.PyQuaticusEnv(team_size=3, config_dict=config_dict, reward_config={'agent_1': defensive_rew},render_mode=None)
