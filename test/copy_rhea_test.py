...
env = pyquaticus_v0.PyQuaticusEnv(team_size=1, config_dict=config_dict, reward_config={ 'agent_0': caps_and_grabs, 'agent_1': caps_and_grabs },render_mode="human")#'human') #TODO change back to 'human' #Yes, this makes the copy work...
#print("env created")
#env2 = deepcopy(env)
