...
from pyquaticus.utils.rewards import test_reward_func, caps_and_grabs, aggressive_rew, defensive_rew

"""
This was copied from heuristic_test.py and modified to 
create a test of 3x ultra-defensive policy agents versus 
3x base_combined agents during the Masters project (Oct 2025).
"""
...
env = pyquaticus_v0.PyQuaticusEnv(team_size=3, config_dict=config_dict, reward_config={'agent_1': defensive_rew}, 
