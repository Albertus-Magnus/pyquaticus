...
H_one = Heuristic_CTF_Agent('agent_3', env, mode="nothing", continuous=True)
H_two = Heuristic_CTF_Agent('agent_4', env, mode="nothing", continuous=True)
H_three = Heuristic_CTF_Agent('agent_5', env, mode="nothing", continuous=True)
