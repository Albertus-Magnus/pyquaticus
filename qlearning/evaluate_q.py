...
if __name__ == "__main__":
    ...
    # batch 9b
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.2, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.2, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.2, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.2, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.1, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.1, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.1, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.1, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.01, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.01, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.001, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.001, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.001, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.001, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.0001, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.0001, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("caps_and_tags", "hard", 0.0001, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # filenames.append(ParameterSet("aggressive_tags_24", "hard", 0.0001, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # batch 9c todo
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.2, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # perhaps oob punishment is too much to avoid: (also just decreased negative punishment generally in this variant reward)
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 0, math2=True).create_name())
    # same again (in case it doesnt converge 100% but some of the time)
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.2, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 1, math2=True).create_name())
    # same again, again
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.2, 0.95, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
    filenames.append(ParameterSet("single_aggressive_rew", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.01, 0.99, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
    filenames.append(ParameterSet("caps_and_tags_oob", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
    filenames.append(ParameterSet("aggressive_oob_tags_24", "hard", 0.5, 0.3, 10.0, False, "math2scatter", "qtrainlog/batch 9/", 2, math2=True).create_name())
